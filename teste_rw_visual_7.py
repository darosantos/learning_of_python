...
while True:
    ...
    # A função figure() controla a largura, a altura, a resolução e a cor de fundo
    # do gráfico. O parâmetro figsize aceita uma tupla, que informa ao
    # matplotlib as dimensões da janela de plotagem em polegadas.
    # Por outro lado, se
    # você souber qual é a resolução de seu sistema, passe-a para figure()
    # usando o parâmetro dpi para definir um tamanho de gráfico que faça um
    # uso eficiente do espaço disponível em sua tela, como vemos a seguir:
